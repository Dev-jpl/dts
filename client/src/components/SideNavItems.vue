    ...
    >
      <div v-if="item.hasSub">
        <button
          ...
          class="flex items-center w-full p-3 transition-all duration-100 hover:bg-gray-200"
          :class="[
            isSubActive(item.routeName)
              ? 'text-teal-800 font-medium border-amber-500 bg-gray-100'
              : 'text-gray-500',
          ]"
        >
        ...
        >
          <RouterLink
            ...
            class="flex items-center py-2 sm:pl-10 hover:bg-gray-100"
            :class="[
              isActive(subItem.routeName)
                ? 'text-teal-800 bg-gray-200 font-semibold border-r-5 border-amber-500'
      ...
      <RouterLink
        v-else
        :to="{ name: item.routeName }"
        class="flex items-center w-full p-3 transition-all duration-100 ease-out hover:bg-gray-200"
        :class="[
          isActive(item.routeName)
            ? 'text-teal-800 bg-gray-200 border-r-6 font-semibold border-amber-500'
